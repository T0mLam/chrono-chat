...
export default function Home() {
  const faqItems = [
    {
      question: "What is Chrono Chat?",
      answer:
        "Chrono Chat is a platform that allows users to communicate and collaborate in real time.",
    },
    {
      question: "How do I create an account?",
      answer:
        'Click the "Sign Up" button on the homepage and follow the instructions to register.',
    },
    {
